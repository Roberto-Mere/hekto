...
export default function ProductCardWide({ id, image, name, price }) {
  return (
    <article className="grid-product group grid h-full basis-full">
      ...
      <ProductCardButtons classes=" flex-col self-end mb-16 justify-self-start grid-overlap z-10 gap-8 self-start p-8 opacity-0 transition-all duration-100 group-odd/hidden:invisible group-even/hidden:invisible group-focus-within:opacity-100 group-hover:opacity-100" />
