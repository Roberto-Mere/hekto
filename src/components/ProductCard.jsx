...
export default function ProductCard({
  ...
  return (
    <article className="grid-product group grid basis-full rounded-xl shadow-normal transition-all duration-300 ease-out focus-within:-translate-y-24 focus-within:shadow-large hover:-translate-y-24 hover:shadow-large">
      <div className="grid-overlap z-10 p-8 opacity-0 transition-all duration-100 group-odd/hidden:invisible group-even/hidden:invisible group-focus-within:opacity-100 group-hover:opacity-100">
        <IconButton
          color="text-tertiary"
